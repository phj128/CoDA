...
from coda.configs import register_store_coda
from coda.utils.vis.rich_logger import print_cfg
from coda.utils.net_utils import load_pretrained_model, get_resume_ckpt_path
...
@hydra.main(version_base="1.3", config_path="../coda/configs", config_name="train")
def main(cfg) -> None:
