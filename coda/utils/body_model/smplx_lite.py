...
from coda.utils.matrix import axis_angle_to_matrix, rotation_6d_to_matrix
...
class SmplxLiteCoco17(SmplxLite):
    ...
    def __init__(self, **kwargs):
        ...
        # Compute mapping
        smplx2smpl = torch.load(PROJ_ROOT / "coda/utils/body_model/smplx2smpl_sparse.pt")
        COCO17_regressor = torch.load(PROJ_ROOT / "coda/utils/body_model/smpl_coco17_J_regressor.pt")
...
class SmplxLiteV437Coco17(SmplxLite):
    def __init__(self, **kwargs):
        ...
        # Verts437
        smplx_vids2 = torch.load(PROJ_ROOT / "coda/utils/body_model/smplx_verts437.pt")
...
class SmplxLiteSmplN24(SmplxLite):
    ...
    def __init__(self, **kwargs):
        ...
        # Compute mapping
        smplx2smpl = torch.load(PROJ_ROOT / "coda/utils/body_model/smplx2smpl_sparse.pt")
        smpl2joints = torch.load(PROJ_ROOT / "coda/utils/body_model/smpl_neutral_J_regressor.pt")
