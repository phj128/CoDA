...
from coda.network.base_arch.transformer.encoder_trajrope import EncoderTrajRoPEBlock, EncoderTrajRoPEBlockDIT
...
class NetworkEncoderRoPE(nn.Module):
    def __init__(
        ...
        block_cls = EncoderTrajRoPEBlockDIT if self.is_dit else EncoderTrajRoPEBlock
